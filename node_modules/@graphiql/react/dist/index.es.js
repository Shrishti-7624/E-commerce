...
import { isNonNullType, isListType, parse as parse$2, TypeInfo, visit, print, getNamedType, isLeafType, Kind, visitWithTypeInfo, typeFromAST, GraphQLFloat, astFromValue, isSchema, getIntrospectionQuery, buildClientSchema, validateSchema, isObjectType, isInterfaceType, isInputObjectType, isNamedType, isEnumType, isAbstractType, isType } from "graphql";
import * as React from "react";
import React__default, { createContext as createContext$1, useContext, useRef, useState, useEffect, useLayoutEffect, useCallback, createElement, PureComponent, forwardRef, useId as useId$1, useMemo, useReducer, Fragment as Fragment$1 } from "react";
...
var blockquote = /* @__PURE__ */ __name(function blockquote2(state, startLine, endLine, silent) {
  var adjustTab, ch, i, initial, l2, lastLineEmpty, lines, nextLine, offset, oldBMarks, oldBSCount, oldIndent, oldParentType, oldSCount, oldTShift, spaceAfterMarker, terminate, terminatorRules, token2, isOutdented, oldLineMax = state.lineMax, pos = state.bMarks[startLine] + state.tShift[startLine], max = state.eMarks[startLine];
  if (state.sCount[startLine] - state.blkIndent >= 4) {
    return false;
  }
...
var reference = /* @__PURE__ */ __name(function reference2(state, startLine, _endLine, silent) {
  var ch, destEndPos, destEndLineNo, endLine, href, i, l2, label, labelEnd, oldParentType, res, start, str, terminate, terminatorRules, title, lines = 0, pos = state.bMarks[startLine] + state.tShift[startLine], max = state.eMarks[startLine], nextLine = startLine + 1;
  if (state.sCount[startLine] - state.blkIndent >= 4) {
    return false;
  }
...
var __name$M = /* @__PURE__ */ __name((target2, value) => __defProp$M(target2, "name", { value, configurable: true }), "__name$M");
...
__name$M(importCodeMirror, "importCodeMirror");
var __defProp$L = Object.defineProperty;
var __name$L = /* @__PURE__ */ __name((target2, value) => __defProp$L(target2, "name", { value, configurable: true }), "__name$L");
function onHasCompletion(_cm, data, schema, explorer, callback) {
  importCodeMirror([], { useCommonAddons: false }).then((CodeMirror) => {
    ...
    CodeMirror.on(data, "select", (ctx, el2) => {
      if (!information) {
        ...
        const handleScroll2 = /* @__PURE__ */ __name$L(() => {
          if (information) {
        ...
        let onRemoveFn;
        hintsUl.addEventListener("DOMNodeRemoved", onRemoveFn = /* @__PURE__ */ __name$L((event) => {
      ...
      if (typeNamePill && typeNamePrefix && typeName && typeNameSuffix) {
        if (ctx.type) {
          ...
          const renderType2 = /* @__PURE__ */ __name$L((type2) => {
  ...
  __name$L(onClickHintInformation, "onClickHintInformation");
}
__name(onHasCompletion, "onHasCompletion");
__name$L(onHasCompletion, "onHasCompletion");
...
var __name$K = /* @__PURE__ */ __name((target2, value) => __defProp$K(target2, "name", { value, configurable: true }), "__name$K");
...
__name$K(createNullableContext, "createNullableContext");
function createContextHook(context) {
  ...
  __name$K(useGivenContext, "useGivenContext");
...
__name$K(createContextHook, "createContextHook");
...
var m$1 = f$1.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, n$1 = Object.prototype.hasOwnProperty, p$2 = { key: true, ref: true, __self: true, __source: true };
...
__name$J(StorageContextProvider, "StorageContextProvider");
...
function t$1(kind, style2) {
  return { style: style2, match: (token2) => token2.kind === kind };
}
__name(t$1, "t$1");
function p$1(value, style2) {
  return {
...
const ParseRules = {
  ...
  FragmentSpread: [p$1("..."), name("def"), list2("Directive")],
  InlineFragment: [
    p$1("..."),
    opt("TypeCondition"),
    list2("Directive"),
...
function SvgKeyboardShortcut(_E) {
  var _F = _E, {
    title,
    titleId
  } = _F, props2 = __objRest(_F, [
...
function SvgMagnifyingGlass(_G) {
  var _H = _G, {
    title,
    titleId
  } = _H, props2 = __objRest(_H, [
...
function generateIcon(RawComponent, title) {
  const WithTitle = /* @__PURE__ */ __name$I(/* @__PURE__ */ __name(function IconComponent(props2) {
...
__name$I(generateIcon, "generateIcon");
...
__name$F(ButtonGroup, "ButtonGroup");
function canUseDOM() {
...
var _excluded$8 = ["unstable_skipInitialRender"];
...
var Portal = /* @__PURE__ */ __name(function Portal2(_ref2) {
  var unstable_skipInitialRender = _ref2.unstable_skipInitialRender, props2 = _objectWithoutPropertiesLoose$9(_ref2, _excluded$8);
...
function _extends$7() {
  _extends$7 = Object.assign ? Object.assign.bind() : function(target2) {
...
var FocusLock$1 = /* @__PURE__ */ React.forwardRef(/* @__PURE__ */ __name(function FocusLockUI(props2, parentRef) {
  ...
  var lockProps = _extends$7((_extends2 = {}, _extends2[FOCUS_DISABLED] = disabled && "disabled", _extends2[FOCUS_GROUP] = group, _extends2), containerProps);
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, hasLeadingGuards && [
    ...
    returnFocus,
    focusOptions
  }), /* @__PURE__ */ React.createElement(Container, _extends$7({
    ref: mergedRef
  }, lockProps, {
    className,
    onBlur: onBlur3,
...
var tabSort = /* @__PURE__ */ __name(function(a, b2) {
...
var FocusLockCombination = /* @__PURE__ */ React.forwardRef(/* @__PURE__ */ __name(function FocusLockUICombination(props2, ref) {
  return /* @__PURE__ */ React.createElement(FocusLockUI2, _extends$7({
    sideCar: FocusTrap,
    ref
  }, props2));
...
_ref.sideCar;
_objectWithoutPropertiesLoose$8(_ref, ["sideCar"]);
...
var getStyles$1 = /* @__PURE__ */ __name(function(_a, allowRelative, gapMode, important) {
...
var RemoveScrollBar = /* @__PURE__ */ __name(function(props2) {
  ...
  return React.createElement(Style, { styles: getStyles$1(gap2, !noRelative, gapMode, !noImportant ? "!important" : "") });
}, "RemoveScrollBar");
...
var _excluded$7 = ["as", "isOpen"], _excluded2$3 = ["allowPinchZoom", "as", "dangerouslyBypassFocusLock", "dangerouslyBypassScrollLock", "initialFocusRef", "onClick", "onDismiss", "onKeyDown", "onMouseDown", "unstable_lockFocusAcrossFrames"], _excluded3$3 = ["as", "onClick", "onKeyDown"], _excluded4$2 = ["allowPinchZoom", "initialFocusRef", "isOpen", "onDismiss"];
({
...
var DialogOverlay = /* @__PURE__ */ forwardRef(/* @__PURE__ */ __name(function DialogOverlay2(_ref2, forwardedRef) {
  var _ref$as = _ref2.as, Comp = _ref$as === void 0 ? "div" : _ref$as, _ref$isOpen = _ref2.isOpen, isOpen = _ref$isOpen === void 0 ? true : _ref$isOpen, props2 = _objectWithoutPropertiesLoose$7(_ref2, _excluded$7);
  useEffect(function() {
    if (isOpen) {
...
var DialogInner = /* @__PURE__ */ forwardRef(/* @__PURE__ */ __name(function DialogInner2(_ref2, forwardedRef) {
  ...
  }, /* @__PURE__ */ createElement(Comp, _extends$6({}, props2, {
    ref,
...
var DialogContent = /* @__PURE__ */ forwardRef(/* @__PURE__ */ __name(function DialogContent2(_ref3, forwardedRef) {
  ...
  _ref3.onKeyDown;
  var props2 = _objectWithoutPropertiesLoose$7(_ref3, _excluded3$3);
  return /* @__PURE__ */ createElement(Comp, _extends$6({
    "aria-modal": "true",
    role: "dialog",
    tabIndex: -1
  }, props2, {
...
var Dialog$1 = /* @__PURE__ */ forwardRef(/* @__PURE__ */ __name(function Dialog(_ref4, forwardedRef) {
  var _ref4$allowPinchZoom = _ref4.allowPinchZoom, allowPinchZoom = _ref4$allowPinchZoom === void 0 ? false : _ref4$allowPinchZoom, initialFocusRef2 = _ref4.initialFocusRef, isOpen = _ref4.isOpen, _ref4$onDismiss = _ref4.onDismiss, onDismiss = _ref4$onDismiss === void 0 ? noop : _ref4$onDismiss, props2 = _objectWithoutPropertiesLoose$7(_ref4, _excluded4$2);
  return /* @__PURE__ */ createElement(DialogOverlay, {
    allowPinchZoom,
    initialFocusRef: initialFocusRef2,
    isOpen,
    onDismiss
  }, /* @__PURE__ */ createElement(DialogContent, _extends$6({
    ref: forwardedRef
  }, props2)));
}, "Dialog"));
...
var _excluded$6 = ["as", "style"];
var VisuallyHidden = /* @__PURE__ */ forwardRef(/* @__PURE__ */ __name(function VisuallyHidden2(_ref2, ref) {
  var _ref$as = _ref2.as, Comp = _ref$as === void 0 ? "span" : _ref$as, _ref$style = _ref2.style, style2 = _ref$style === void 0 ? {} : _ref$style, props2 = _objectWithoutPropertiesLoose$6(_ref2, _excluded$6);
  return /* @__PURE__ */ createElement(Comp, _extends$5({
    ref,
    style: _extends$5({
      border: 0,
      clip: "rect(0 0 0 0)",
...
function Dialog2(props2) {
  return /* @__PURE__ */ jsx(Dialog$1, __spreadValues({}, props2));
}
__name(Dialog2, "Dialog");
__name$E(Dialog2, "Dialog");
function DialogClose(props2) {
...
__name$E(DialogClose, "DialogClose");
Dialog2.Close = DialogClose;
var props = ["bottom", "height", "left", "right", "top", "width"];
var rectChanged = /* @__PURE__ */ __name(function rectChanged2(a, b2) {
  if (a === void 0) {
    a = {};
  }
  if (b2 === void 0) {
...
var _excluded$5 = ["unstable_skipInitialPortalRender"], _excluded2$2 = ["as", "targetRef", "position", "unstable_observableRefs"];
var Popover = /* @__PURE__ */ forwardRef(/* @__PURE__ */ __name(function Popover2(_ref2, ref) {
  var unstable_skipInitialPortalRender = _ref2.unstable_skipInitialPortalRender, props2 = _objectWithoutPropertiesLoose$5(_ref2, _excluded$5);
  return /* @__PURE__ */ createElement(Portal, {
    unstable_skipInitialRender: unstable_skipInitialPortalRender
  }, /* @__PURE__ */ createElement(PopoverImpl, _extends$4({
    ref
  }, props2)));
}, "Popover"));
var PopoverImpl = /* @__PURE__ */ forwardRef(/* @__PURE__ */ __name(function PopoverImpl2(_ref2, forwardedRef) {
  var _ref2$as = _ref2.as, Comp = _ref2$as === void 0 ? "div" : _ref2$as, targetRef = _ref2.targetRef, _ref2$position = _ref2.position, position = _ref2$position === void 0 ? positionDefault : _ref2$position, _ref2$unstable_observ = _ref2.unstable_observableRefs, unstable_observableRefs = _ref2$unstable_observ === void 0 ? [] : _ref2$unstable_observ, props2 = _objectWithoutPropertiesLoose$5(_ref2, _excluded2$2);
...
var _excluded$4 = ["element", "index"];
function createDescendantContext(name2, initialValue) {
  if (initialValue === void 0) {
    initialValue = {};
  }
  var descendants = [];
  var ctx = /* @__PURE__ */ createContext$1(_extends$3({
    descendants,
...
function DescendantProvider(_ref2) {
  ...
  var registerDescendant = useCallback(function(_ref22) {
    var element = _ref22.element, explicitIndex = _ref22.index, rest = _objectWithoutPropertiesLoose$4(_ref22, _excluded$4);
    if (!element) {
      return;
    }
    set2(function(items2) {
      ...
      if (explicitIndex != null) {
        return [].concat(items2, [_extends$3({}, rest, {
          element,
          index: explicitIndex
        })]).sort(function(a, b2) {
...
function createContext(rootName, defaultContext) {
  ...
  function Provider(props2) {
    var children = props2.children, context = _objectWithoutPropertiesLoose$3(props2, _excluded$3);
...
function useStatefulRefValue(ref, initialState2) {
  var _useState = useState(initialState2), state = _useState[0], setState = _useState[1];
...
var _excluded$2 = ["onKeyDown", "onMouseDown", "id", "ref"], _excluded3$2 = ["index", "isLink", "onClick", "onDragStart", "onMouseDown", "onMouseEnter", "onMouseLeave", "onMouseMove", "onMouseUp", "onSelect", "disabled", "onFocus", "valueText", "ref"], _excluded5$2 = ["id", "onKeyDown", "ref"], _excluded7$1 = ["onBlur", "portal", "position", "ref"];
...
var DropdownProvider_ = /* @__PURE__ */ __name(function DropdownProvider_2(_ref2) {
  ...
  var _React$useReducer = useReducer(reducer$1, _extends$2({}, initialState, {
    triggerId
...
function useDropdownTrigger(_ref2) {
  var onKeyDown = _ref2.onKeyDown, onMouseDown = _ref2.onMouseDown, id2 = _ref2.id, forwardedRef = _ref2.ref, props2 = _objectWithoutPropertiesLoose$2(_ref2, _excluded$2);
...
function useDropdownItem(_ref4) {
  var indexProp = _ref4.index, _ref4$isLink = _ref4.isLink, isLink = _ref4$isLink === void 0 ? false : _ref4$isLink, onClick = _ref4.onClick, onDragStart = _ref4.onDragStart, onMouseDown = _ref4.onMouseDown, onMouseEnter = _ref4.onMouseEnter, onMouseLeave = _ref4.onMouseLeave, onMouseMove = _ref4.onMouseMove, onMouseUp = _ref4.onMouseUp, onSelect = _ref4.onSelect, disabled = _ref4.disabled, onFocus3 = _ref4.onFocus, valueTextProp = _ref4.valueText, forwardedRef = _ref4.ref, props2 = _objectWithoutPropertiesLoose$2(_ref4, _excluded3$2);
...
function useDropdownItems(_ref6) {
  _ref6.id;
  var onKeyDown = _ref6.onKeyDown, forwardedRef = _ref6.ref, props2 = _objectWithoutPropertiesLoose$2(_ref6, _excluded5$2);
  ...
  useEffect(function() {
    var match2 = findItemFromTypeahead(items, typeaheadQuery);
    if (typeaheadQuery && match2 != null) {
      dispatch({
        type: SELECT_ITEM_AT_INDEX,
        payload: {
          index: match2,
...
function useDropdownPopover(_ref8) {
  var onBlur3 = _ref8.onBlur, _ref8$portal = _ref8.portal, portal = _ref8$portal === void 0 ? true : _ref8$portal, position = _ref8.position, forwardedRef = _ref8.ref, props2 = _objectWithoutPropertiesLoose$2(_ref8, _excluded7$1);
...
var _excluded$1 = ["as", "id", "children"], _excluded2$1 = ["as"], _excluded3$1 = ["as"], _excluded4$1 = ["as"], _excluded5$1 = ["as"], _excluded7 = ["portal"], _excluded8 = ["as"];
var Menu$1 = /* @__PURE__ */ forwardRef(function(_ref2, forwardedRef) {
  var _ref$as = _ref2.as, Comp = _ref$as === void 0 ? Fragment$1 : _ref$as, id2 = _ref2.id, children = _ref2.children, rest = _objectWithoutPropertiesLoose$1(_ref2, _excluded$1);
  ...
  var props2 = parentIsFragment ? {} : _extends$1({
    ref: forwardedRef,
    id: id2,
    "data-reach-menu": ""
  }, rest);
...
var MenuButton = /* @__PURE__ */ forwardRef(function(_ref2, forwardedRef) {
  var _ref2$as = _ref2.as, Comp = _ref2$as === void 0 ? "button" : _ref2$as, rest = _objectWithoutPropertiesLoose$1(_ref2, _excluded2$1);
  var _useDropdownTrigger = useDropdownTrigger(_extends$1({}, rest, {
    ref: forwardedRef
...
var MenuItemImpl = /* @__PURE__ */ forwardRef(function(_ref3, forwardedRef) {
  var _ref3$as = _ref3.as, Comp = _ref3$as === void 0 ? "div" : _ref3$as, rest = _objectWithoutPropertiesLoose$1(_ref3, _excluded3$1);
  var _useDropdownItem = useDropdownItem(_extends$1({}, rest, {
    ref: forwardedRef
...
var MenuItem = /* @__PURE__ */ forwardRef(function(_ref4, forwardedRef) {
  var _ref4$as = _ref4.as, as = _ref4$as === void 0 ? "div" : _ref4$as, props2 = _objectWithoutPropertiesLoose$1(_ref4, _excluded4$1);
  return /* @__PURE__ */ createElement(MenuItemImpl, _extends$1({}, props2, {
    ref: forwardedRef,
    as
  }));
});
var MenuItems = /* @__PURE__ */ forwardRef(function(_ref5, forwardedRef) {
  var _ref5$as = _ref5.as, Comp = _ref5$as === void 0 ? "div" : _ref5$as, rest = _objectWithoutPropertiesLoose$1(_ref5, _excluded5$1);
  var _useDropdownItems = useDropdownItems(_extends$1({}, rest, {
    ref: forwardedRef
...
var MenuList = /* @__PURE__ */ forwardRef(function(_ref7, forwardedRef) {
  var _ref7$portal = _ref7.portal, portal = _ref7$portal === void 0 ? true : _ref7$portal, props2 = _objectWithoutPropertiesLoose$1(_ref7, _excluded7);
  return /* @__PURE__ */ createElement(MenuPopover, {
    portal
  }, /* @__PURE__ */ createElement(MenuItems, _extends$1({}, props2, {
    ref: forwardedRef,
    "data-reach-menu-list": ""
  })));
});
var MenuPopover = /* @__PURE__ */ forwardRef(function(_ref8, forwardedRef) {
  var _ref8$as = _ref8.as, Comp = _ref8$as === void 0 ? "div" : _ref8$as, rest = _objectWithoutPropertiesLoose$1(_ref8, _excluded8);
  var _useDropdownPopover = useDropdownPopover(_extends$1({}, rest, {
    ref: forwardedRef
  ...
  return portal ? /* @__PURE__ */ createElement(Popover, _extends$1({}, props2, sharedProps, {
    as: Comp,
    targetRef,
    position,
    unstable_skipInitialPortalRender: true
  })) : /* @__PURE__ */ createElement(Comp, _extends$1({}, props2, sharedProps));
});
var __defProp$D = Object.defineProperty;
var __name$D = /* @__PURE__ */ __name((target2, value) => __defProp$D(target2, "name", { value, configurable: true }), "__name$D");
const createComponentGroup = /* @__PURE__ */ __name$D((root2, children) => Object.entries(children).reduce((r2, [key, value]) => {
  r2[key] = value;
  return r2;
...
function MarkdownContent(props2) {
  return /* @__PURE__ */ jsx("div", {
    className: `graphiql-markdown-${props2.type}${props2.onlyShowFirstChild ? " graphiql-markdown-preview" : ""}`,
    dangerouslySetInnerHTML: {
      __html: markdown$1.render(props2.children)
    }
  });
}
__name(MarkdownContent, "MarkdownContent");
__name$C(MarkdownContent, "MarkdownContent");
var spinner = "";
var __defProp$B = Object.defineProperty;
var __name$B = /* @__PURE__ */ __name((target2, value) => __defProp$B(target2, "name", { value, configurable: true }), "__name$B");
function Spinner() {
  return /* @__PURE__ */ jsx("div", {
    className: "graphiql-spinner"
  });
}
__name(Spinner, "Spinner");
__name$B(Spinner, "Spinner");
var tabs = "";
...
__name(TabButton, "TabButton");
__name$A(TabButton, "TabButton");
Tab.Button = TabButton;
function TabClose(props2) {
  return /* @__PURE__ */ jsx(UnStyledButton, __spreadProps(__spreadValues({
...
__name(TabClose, "TabClose");
__name$A(TabClose, "TabClose");
Tab.Close = TabClose;
...
var __name$z = /* @__PURE__ */ __name((target2, value) => __defProp$z(target2, "name", { value, configurable: true }), "__name$z");
...
function HistoryContextProvider(props2) {
  ...
  const [isVisible, setIsVisible] = useState((storage == null ? void 0 : storage.get(STORAGE_KEY$5)) === "true" || false);
  ...
  const hide = useCallback(() => {
    ...
    storage == null ? void 0 : storage.set(STORAGE_KEY$5, JSON.stringify(false));
    setIsVisible(false);
  }, [onToggle, storage]);
  const show = useCallback(() => {
    onToggle == null ? void 0 : onToggle(true);
    storage == null ? void 0 : storage.set(STORAGE_KEY$5, JSON.stringify(true));
    setIsVisible(true);
  }, [onToggle, storage]);
  const toggle = useCallback(() => {
    setIsVisible((current) => {
      ...
      storage == null ? void 0 : storage.set(STORAGE_KEY$5, JSON.stringify(newValue));
      return newValue;
    });
  }, [onToggle, storage]);
...
__name$z(HistoryContextProvider, "HistoryContextProvider");
const useHistoryContext = createContextHook(HistoryContext);
const DEFAULT_HISTORY_LENGTH = 20;
const STORAGE_KEY$5 = "historyPaneOpen";
var style = "";
var __defProp$y = Object.defineProperty;
var __name$y = /* @__PURE__ */ __name((target2, value) => __defProp$y(target2, "name", { value, configurable: true }), "__name$y");
function History() {
  const {
    items
  } = useHistoryContext({
  ...
  return /* @__PURE__ */ jsx("li", {
    ...
    children: isEditable ? /* @__PURE__ */ jsxs(Fragment, {
      ...
      children: [/* @__PURE__ */ jsx(UnStyledButton, {
        ...
        title: props2.item.favorite ? "Remove favorite" : "Add favorite",
        children: props2.item.favorite ? /* @__PURE__ */ jsx(StarFilledIcon, {}) : /* @__PURE__ */ jsx(StarIcon, {})
      })]
    })
  });
}
__name(HistoryItem, "HistoryItem");
__name$y(HistoryItem, "HistoryItem");
...
__name$y(formatQuery, "formatQuery");
var __defProp$x = Object.defineProperty;
var __name$x = /* @__PURE__ */ __name((target2, value) => __defProp$x(target2, "name", { value, configurable: true }), "__name$x");
...
function ExecutionContextProvider(props2) {
  ...
  const run3 = useCallback(async (_selectedOperationName) => {
    var _a;
    ...
    const setResponse = /* @__PURE__ */ __name$x((value2) => {
    ...
    if (externalFragments) {
      ...
      if (Array.isArray(externalFragments)) {
        ...
        visit(parse$2(externalFragments, {}), {
    ...
    try {
      ...
      const handleResponse = /* @__PURE__ */ __name$x((result) => {
  ...
  const value = useMemo(() => ({
    ...
    stop,
    subscription
  }), [isFetching, run3, stop, subscription]);
...
__name$x(ExecutionContextProvider, "ExecutionContextProvider");
...
__name$x(tryParseJsonObject, "tryParseJsonObject");
...
var __name$w = /* @__PURE__ */ __name((target2, value) => __defProp$w(target2, "name", { value, configurable: true }), "__name$w");
const printDefault = /* @__PURE__ */ __name$w((ast2) => {
  if (!ast2) {
    return "";
  }
  return print(ast2);
...
__name$w(DefaultValue, "DefaultValue");
var __defProp$v = Object.defineProperty;
var __name$v = /* @__PURE__ */ __name((target2, value) => __defProp$v(target2, "name", { value, configurable: true }), "__name$v");
...
function SchemaContextProvider(props2) {
  ...
  const introspect = useCallback(() => {
    ...
    __name$v(fetchIntrospectionData, "fetchIntrospectionData");
  ...
  useEffect(() => {
    ...
    __name$v(triggerIntrospection, "triggerIntrospection");
...
__name$v(SchemaContextProvider, "SchemaContextProvider");
...
__name$v(useIntrospectionQuery, "useIntrospectionQuery");
...
__name$v(parseHeaderString, "parseHeaderString");
var __defProp$u = Object.defineProperty;
var __name$u = /* @__PURE__ */ __name((target2, value) => __defProp$u(target2, "name", { value, configurable: true }), "__name$u");
...
function ExplorerContextProvider(props2) {
  ...
  const storage = useStorageContext();
  const [isVisible, setIsVisible] = useState((_b = (_a = props2.isVisible) != null ? _a : (storage == null ? void 0 : storage.get(STORAGE_KEY$4)) === "true") != null ? _b : false);
  ...
  useEffect(() => {
    if (isInitialRender.current) {
      isInitialRender.current = false;
    } else if (props2.isVisible !== void 0) {
      setIsVisible(props2.isVisible);
    }
  }, [props2.isVisible]);
  const hide = useCallback(() => {
    onToggleVisibility == null ? void 0 : onToggleVisibility(false);
    storage == null ? void 0 : storage.set(STORAGE_KEY$4, "false");
    setIsVisible(false);
  ...
  const show = useCallback(() => {
    ...
    storage == null ? void 0 : storage.set(STORAGE_KEY$4, "true");
    setIsVisible(true);
  }, [onToggleVisibility, storage]);
  useEffect(() => {
    if (isFetching) {
...
__name$u(ExplorerContextProvider, "ExplorerContextProvider");
const useExplorerContext = createContextHook(ExplorerContext);
const STORAGE_KEY$4 = "docExplorerOpen";
var __defProp$t = Object.defineProperty;
var __name$t = /* @__PURE__ */ __name((target2, value) => __defProp$t(target2, "name", { value, configurable: true }), "__name$t");
...
__name$t(renderType, "renderType");
var typeLink = "";
var __defProp$s = Object.defineProperty;
var __name$s = /* @__PURE__ */ __name((target2, value) => __defProp$s(target2, "name", { value, configurable: true }), "__name$s");
...
__name$s(TypeLink, "TypeLink");
var argument = "";
var __defProp$r = Object.defineProperty;
var __name$r = /* @__PURE__ */ __name((target2, value) => __defProp$r(target2, "name", { value, configurable: true }), "__name$r");
function Argument({
  arg,
  showDefaultValue,
  inline: inline3
...
__name$r(Argument, "Argument");
var deprecationReason = "";
var __defProp$q = Object.defineProperty;
var __name$q = /* @__PURE__ */ __name((target2, value) => __defProp$q(target2, "name", { value, configurable: true }), "__name$q");
...
__name$q(DeprecationReason, "DeprecationReason");
var directive = "";
var __defProp$p = Object.defineProperty;
var __name$p = /* @__PURE__ */ __name((target2, value) => __defProp$p(target2, "name", { value, configurable: true }), "__name$p");
function Directive({
...
__name$p(Directive, "Directive");
var section = "";
var __defProp$o = Object.defineProperty;
var __name$o = /* @__PURE__ */ __name((target2, value) => __defProp$o(target2, "name", { value, configurable: true }), "__name$o");
function ExplorerSection(props2) {
  const Icon = TYPE_TO_ICON[props2.title];
  return /* @__PURE__ */ jsxs("div", {
    children: [/* @__PURE__ */ jsxs("div", {
      className: "graphiql-doc-explorer-section-title",
      children: [/* @__PURE__ */ jsx(Icon, {}), props2.title]
    }), /* @__PURE__ */ jsx("div", {
...
__name$o(ExplorerSection, "ExplorerSection");
const TYPE_TO_ICON = {
...
var __name$n = /* @__PURE__ */ __name((target2, value) => __defProp$n(target2, "name", { value, configurable: true }), "__name$n");
...
__name$n(FieldDocumentation, "FieldDocumentation");
function Arguments({
  field
}) {
...
__name$n(Directives, "Directives");
var schemaDocumentation = "";
var __defProp$m = Object.defineProperty;
var __name$m = /* @__PURE__ */ __name((target2, value) => __defProp$m(target2, "name", { value, configurable: true }), "__name$m");
...
__name$m(SchemaDocumentation, "SchemaDocumentation");
...
var Combobox = /* @__PURE__ */ forwardRef(function(_ref2, forwardedRef) {
  ...
  var _useReducerMachine = useReducerMachine(stateChart, reducer, defaultData), state = _useReducerMachine[0], data = _useReducerMachine[1], transition = _useReducerMachine[2];
...
var ComboboxInput = /* @__PURE__ */ forwardRef(function(_ref2, forwardedRef) {
  ...
  var _React$useContext = useContext(ComboboxContext), _React$useContext$dat = _React$useContext.data, navigationValue = _React$useContext$dat.navigationValue, value = _React$useContext$dat.value, lastEventType = _React$useContext$dat.lastEventType, inputRef = _React$useContext.inputRef, state = _React$useContext.state, transition = _React$useContext.transition, listboxId = _React$useContext.listboxId, autocompletePropRef = _React$useContext.autocompletePropRef, openOnFocus = _React$useContext.openOnFocus, isExpanded = _React$useContext.isExpanded, ariaLabel = _React$useContext.ariaLabel, ariaLabelledby = _React$useContext.ariaLabelledby, persistSelectionRef = _React$useContext.persistSelectionRef, isControlledRef = _React$useContext.isControlledRef;
  ...
  var handleValueChange = useCallback(function(value2) {
    if (value2.trim() === "") {
      transition(CLEAR, {
        isControlled
      });
  ...
  __name(handleClick, "handleClick");
  var inputValue = autocomplete && (state === NAVIGATING || state === INTERACTING) ? navigationValue || controlledValue || value : controlledValue || value;
...
var ComboboxPopover = /* @__PURE__ */ forwardRef(function(_ref3, forwardedRef) {
  ...
  var _React$useContext2 = useContext(ComboboxContext), popoverRef = _React$useContext2.popoverRef, inputRef = _React$useContext2.inputRef, isExpanded = _React$useContext2.isExpanded, state = _React$useContext2.state;
  var ref = useComposedRefs(popoverRef, forwardedRef);
  var handleKeyDown = useKeyDown();
  var handleBlur = useBlur();
  var sharedProps = {
...
var ComboboxOption = /* @__PURE__ */ forwardRef(function(_ref5, forwardedRef) {
  var _ref5$as = _ref5.as, Comp = _ref5$as === void 0 ? "li" : _ref5$as, children = _ref5.children, indexProp = _ref5.index, value = _ref5.value, onClick = _ref5.onClick, props2 = _objectWithoutPropertiesLoose(_ref5, _excluded5);
  var _React$useContext4 = useContext(ComboboxContext), onSelect = _React$useContext4.onSelect, navigationValue = _React$useContext4.data.navigationValue, transition = _React$useContext4.transition, isControlledRef = _React$useContext4.isControlledRef;
  var ownRef = useRef(null);
  var _useStatefulRefValue = useStatefulRefValue(ownRef, null), element = _useStatefulRefValue[0], handleRefSet = _useStatefulRefValue[1];
  var descendant = useMemo(function() {
    return {
...
function ComboboxOptionText() {
  var _React$useContext5 = useContext(OptionContext), value = _React$useContext5.value;
...
function useKeyDown() {
  var _React$useContext8 = useContext(ComboboxContext), navigationValue = _React$useContext8.data.navigationValue, onSelect = _React$useContext8.onSelect, state = _React$useContext8.state, transition = _React$useContext8.transition, autocompletePropRef = _React$useContext8.autocompletePropRef, persistSelectionRef = _React$useContext8.persistSelectionRef, isControlledRef = _React$useContext8.isControlledRef;
...
function useBlur() {
  var _React$useContext9 = useContext(ComboboxContext), state = _React$useContext9.state, transition = _React$useContext9.transition, popoverRef = _React$useContext9.popoverRef, inputRef = _React$useContext9.inputRef, buttonRef = _React$useContext9.buttonRef;
...
function useReducerMachine(chart, reducer3, initialData) {
  var _React$useState = useState(chart.initial), state = _React$useState[0], setState = _React$useState[1];
  var _React$useReducer = useReducer(reducer3, initialData), data = _React$useReducer[0], dispatch = _React$useReducer[1];
  var transition = /* @__PURE__ */ __name(function transition2(event, payload) {
    if (payload === void 0) {
      payload = {};
    }
...
function Search() {
  ...
  useEffect(() => {
    ...
    __name(handleKeyDown, "handleKeyDown");
    __name$k(handleKeyDown, "handleKeyDown");
...
__name$k(useSearchResults, "useSearchResults");
...
__name$i(TypeDocumentation, "TypeDocumentation");
...
__name$i(ImplementsInterfaces, "ImplementsInterfaces");
function Fields({
  type: type2
}) {
  const [showDeprecated, setShowDeprecated] = useState(false);
...
__name$i(EnumValues, "EnumValues");
function EnumValue({
  value
}) {
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsx("div", {
      ...
      children: value.name
    }), value.description ? /* @__PURE__ */ jsx(MarkdownContent, {
      type: "description",
      children: value.description
    }) : null, value.deprecationReason ? /* @__PURE__ */ jsx(MarkdownContent, {
      type: "deprecation",
...
__name$i(PossibleTypes, "PossibleTypes");
var docExplorer = "";
var __defProp$h = Object.defineProperty;
var __name$h = /* @__PURE__ */ __name((target2, value) => __defProp$h(target2, "name", { value, configurable: true }), "__name$h");
    ...
    children: [/* @__PURE__ */ jsxs("div", {
      ...
      children: [/* @__PURE__ */ jsxs("div", {
        ...
        children: [prevName && /* @__PURE__ */ jsxs("a", {
          ...
          children: navItem.title || navItem.name
        })]
      }), /* @__PURE__ */ jsx("div", {
...
__name$h(DocExplorer, "DocExplorer");
var __defProp$g = Object.defineProperty;
var __name$g = /* @__PURE__ */ __name((target2, value) => __defProp$g(target2, "name", { value, configurable: true }), "__name$g");
function useSynchronizeValue(editor2, value) {
  useEffect(() => {
    if (editor2 && typeof value !== "undefined" && value !== editor2.getValue()) {
...
function useSynchronizeOption(editor2, option, value) {
  useEffect(() => {
    if (editor2) {
      editor2.setOption(option, value);
    }
  }, [editor2, option, value]);
}
...
function useCompletion(editor2, callback, caller) {
  ...
  useEffect(() => {
    ...
    const handleCompletion = /* @__PURE__ */ __name$g((instance, changeObj) => {
      onHasCompletion(instance, changeObj, schema, explorer, (type2) => {
  ...
  }, [callback, editor2, explorer, schema]);
}
...
function useSynchronizeExternalFragments(editor2, externalFragments, codeMirrorRef) {
  useEffect(() => {
    ...
    const didChange = editor2.options.lint.externalFragments !== externalFragments;
    editor2.state.lint.linterOptions.externalFragments = externalFragments;
    editor2.options.lint.externalFragments = externalFragments;
    editor2.options.hintOptions.externalFragments = externalFragments;
    if (didChange && codeMirrorRef.current) {
      codeMirrorRef.current.signal(editor2, "change", editor2);
    }
  }, [editor2, externalFragments, codeMirrorRef]);
}
...
function getDefaultTabState({
  ...
  try {
    ...
    storage == null ? void 0 : storage.set(STORAGE_KEY$2, "");
...
function EditorContextProvider(props2) {
  ...
  const [storedEditorValues] = useState(() => {
    ...
    return {
      headers: (_b2 = (_a2 = props2.headers) != null ? _a2 : storage == null ? void 0 : storage.get(STORAGE_KEY$3)) != null ? _b2 : null,
      query: (_d2 = (_c2 = props2.query) != null ? _c2 : storage == null ? void 0 : storage.get(STORAGE_KEY_QUERY)) != null ? _d2 : null,
      variables: (_f = (_e = props2.variables) != null ? _e : storage == null ? void 0 : storage.get(STORAGE_KEY$1)) != null ? _f : null
    };
  });
  ...
  const defaultQuery = tabState.activeTabIndex > 0 ? "" : (_a = props2.defaultQuery) != null ? _a : DEFAULT_QUERY;
...
function HeaderEditor(_ga) {
  var _ha = _ga, {
    isHidden: isHidden2
  } = _ha, hookArgs = __objRest(_ha, [
    "isHidden"
  ]);
  const {
    headerEditor
...
function VariableEditor(_ia) {
  var _ja = _ia, {
    isHidden: isHidden2
  } = _ja, hookArgs = __objRest(_ja, [
    "isHidden"
  ]);
  const {
    variableEditor
...
function ToolbarButton(props2) {
  ...
  return /* @__PURE__ */ jsx(UnStyledButton, __spreadProps(__spreadValues({}, props2), {
    className: "graphiql-toolbar-button" + (error2 ? " error" : "") + (props2.className ? " " + props2.className : ""),
    onClick: (event) => {
      var _a;
      try {
...
function ExecuteButton() {
  ...
  return hasOptions ? /* @__PURE__ */ jsxs(Menu, {
    children: [/* @__PURE__ */ jsx(Menu.Button, __spreadValues({}, buttonProps)), /* @__PURE__ */ jsx(Menu.List, {
      children: operations.map((operation, i) => {
        const opName = operation.name ? operation.name.value : `<Unnamed ${operation.operation}>`;
        return /* @__PURE__ */ jsx(Menu.Item, {
          onSelect: () => {
            var _a;
            run3((_a = operation.name) == null ? void 0 : _a.value);
          },
          children: opName
        }, `${opName}-${i}`);
      })
    })]
  }) : /* @__PURE__ */ jsx("button", __spreadProps(__spreadValues({}, buttonProps), {
    onClick: () => {
      if (isRunning) {
        stop();
      } else {
...
__name$1(ExecuteButton, "ExecuteButton");
...
export { StorageContext as $, Argument as A, ExplorerContextProvider as B, CompletionItemKind as C, DefaultValue as D, EditorContext as E, ExplorerSection as F, FieldDocumentation as G, HeaderEditor as H, InsertTextFormat as I, FieldLink as J, Search as K, LexRules as L, TypeLink as M, useExplorerContext as N, History as O, ParseRules as P, QueryEditor as Q, RuleKinds as R, SchemaDocumentation as S, TypeDocumentation as T, HistoryContext as U, VariableEditor as V, HistoryContextProvider as W, useHistoryContext as X, SchemaContext as Y, SchemaContextProvider as Z, useSchemaContext as _, EditorContextProvider as a, StorageContextProvider as a0, useStorageContext as a1, useTheme as a2, useDragResize as a3, ArgumentIcon as a4, ChevronDownIcon as a5, ChevronLeftIcon as a6, ChevronUpIcon as a7, CloseIcon as a8, CopyIcon as a9, Button as aA, ButtonGroup as aB, Dialog2 as aC, Menu as aD, MarkdownContent as aE, Spinner as aF, Tab as aG, Tabs as aH, DeprecatedArgumentIcon as aa, DeprecatedEnumValueIcon as ab, DeprecatedFieldIcon as ac, DirectiveIcon as ad, DocsIcon as ae, EnumValueIcon as af, FieldIcon as ag, HistoryIcon as ah, ImplementsIcon as ai, KeyboardShortcutIcon as aj, MagnifyingGlassIcon as ak, MergeIcon as al, PenIcon as am, PlayIcon as an, PlusIcon as ao, PrettifyIcon as ap, ReloadIcon as aq, RootTypeIcon as ar, SettingsIcon as as, StarFilledIcon as at, StarIcon as au, StopIcon as av, TypeIcon as aw, ToolbarButton as ax, ExecuteButton as ay, UnStyledButton as az, ImagePreview as b, commonjsGlobal as c, onHasCompletion as d, ResponseEditor as e, useCopyQuery as f, useEditorContext as g, useHeaderEditor as h, isIgnored as i, useMergeQuery as j, usePrettifyEditors as k, list2 as l, useQueryEditor as m, useResponseEditor as n, opt as o, p$1 as p, useVariableEditor as q, ExecutionContext as r, ExecutionContextProvider as s, t$1 as t, useAutoCompleteLeafs as u, useExecutionContext as v, DeprecationReason as w, Directive as x, DocExplorer as y, ExplorerContext as z };
